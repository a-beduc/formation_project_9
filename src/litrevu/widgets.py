...
class CustomFileInput(ClearableFileInput):
    """
    Custom file input widget rendering a file upload input with a
    template suited to the application design. Overrides default
    ClearableFileInput labels and template.
    """
